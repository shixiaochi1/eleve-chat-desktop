...
// 🔴 round-116 P4.5：roomRowReads / RoomCard / FilterGroup 的定义已迁至 ./bots/*
// （新面板不再依赖待删文件）；此处 import 供本文件继续使用，并再导出保持旧调用点零改动。
import { RoomCard, roomRowReads } from './bots/RoomCard';
import { FilterGroup } from './bots/FilterGroup';

export { RoomCard, roomRowReads, FilterGroup };
